            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST"
                        ...
                        <div class="form-group{{ $errors->has('display_sales') ? ' has-error' : '' }}">
                            <label for="display_sales" class="col-md-4 control-label">
                        ...
                        @if (!Auth::user()->orcid)
                        <div class="form-group{{ $errors->has('orcid') ? ' has-error' : '' }}">
